...
class EditContact extends Component {
 ...
 submit = async (dispatch, size, e) => {
    ...
    const editContact = {
            ...
            try{
            const res = await axios.put(`https://jsonplaceholder.typicode.com/users/${id}`,editContact)
                dispatch({
                    type :  'Edit_CONTACT',
                    payload: res.data
                })
                   ...
                   <div className="card-body">
                       ...
                       <div className="card-text">
                          ...
                          <TextinputGroup  
                            ...
                            <button type="submit"  className="btn btn-danger btn-block">Edit Contact</button>      
                       </div>
                   </div>
               </div>
           </form>   
